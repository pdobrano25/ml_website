...
This took about 45 minutes to run. Now we will evaluate the performance by calculating the Pearson correlation coefficients for each model and each iteration.
...
Other (faster!) models perform comparably, like elastic net (glmnet) and random forest (ranger). 
