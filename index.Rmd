...
The objective is to provide examples of workflows that enable predicting *something* from high dimensional data.
...
**Projects**: machine learning workflows (in R) are provided based on existing publications by other research groups. In most cases, analyses are validated and extended.
 ...
 - [Microbial Load Predictor](https://pdobrano25.github.io/ml_website/mlp_validation.html): A novel tool that predicts the number of bacterial cells in a metagenomic sample. A regression problem with internal and external validation. *Additional models* are evaluated.
